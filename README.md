...
[![CI](https://img.shields.io/github/actions/workflow/status/neurekadev/warrden/CI.yaml?branch=main&style=flat-square&label=CI&color=8B5CF6&logo=githubactions&logoColor=8B5CF6)](https://github.com/neurekadev/warrden/actions/workflows/CI.yaml)
